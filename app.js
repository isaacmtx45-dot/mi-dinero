var Ge=Number.MAX_SAFE_INTEGER;function h(e){let a=typeof e=="number"?e:Number(e);return Number.isFinite(a)?Math.abs(a)>Ge?a<0?-Ge:Ge:Math.round(a):0}function oe(e,a){return h(e*a)}var $a=100;function Vo(e,a){return a<=0?"sin_pagar":a>=e+$a?"pagaron_de_mas":a>=e-$a?"completa":"parcial"}function te(e,a){let o=new Map;for(let t of a){let n=o.get(t.cuentaDeCobroId)??[];n.push(t),o.set(t.cuentaDeCobroId,n)}return e.map(t=>{let n=(o.get(t.id)??[]).slice().sort((i,l)=>i.fecha.localeCompare(l.fecha)),s=n.reduce((i,l)=>i+h(l.monto),0),r=Vo(h(t.montoEsperado),s);return{cuenta:t,ingresos:n,recibido:s,pendiente:r==="completa"?0:Math.max(0,h(t.montoEsperado)-s),estado:r,ultimoPago:n.length?n[n.length-1].fecha:null}})}function Ma(e){return e.filter(a=>a.pendiente>0)}function $e(e){return e.reduce((a,o)=>a+o.pendiente,0)}var ve=new Intl.NumberFormat("es-CO");function Da(e){let a=`$${ve.format(e.cuenta.montoEsperado)}`,o=`$${ve.format(e.recibido)}`;switch(e.estado){case"sin_pagar":return`${e.cuenta.periodo}: sin pagar \xB7 te deben ${a}`;case"parcial":return`${e.cuenta.periodo}: te pagaron ${o} de ${a} \xB7 faltan $${ve.format(e.pendiente)}`;case"completa":return`${e.cuenta.periodo}: pagada completa (${o})`;case"pagaron_de_mas":return`${e.cuenta.periodo}: te pagaron ${o} de ${a} \xB7 $${ve.format(e.recibido-e.cuenta.montoEsperado)} de mas`}}function Go(e,a){let o=new Date(e.getTime());return o.setDate(o.getDate()+a),o}function Me(e,a,o){return Go(a,(e-1)*o)}function A(e,a){let o=Math.max(1,a.diasOptimista);return{optimista:Me(e,a.desde,o),pesimista:Me(e,a.desde,Math.max(o,a.diasPesimista))}}function Ye(e){return e.diasPesimista<=e.diasOptimista}var Yo=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function j(e){return`${Yo[e.getMonth()]} de ${e.getFullYear()}`}var Ea=["ene.","feb.","mar.","abr.","mayo","jun.","jul.","ago.","sept.","oct.","nov.","dic."];function De(e){let[a,o]=[e.optimista,e.pesimista],t=Ea[a.getMonth()],n=Ea[o.getMonth()];return a.getFullYear()!==o.getFullYear()?`${t} ${a.getFullYear()} \u2013 ${n} ${o.getFullYear()}`:a.getMonth()===o.getMonth()?`${t} ${a.getFullYear()}`:`${t} \u2013 ${n} ${o.getFullYear()}`}function Y(e){let a=j(e.optimista),o=j(e.pesimista);return a===o?a:`entre ${a} y ${o}`}function Ee(e){return new Map(e.map(a=>[a.id,Math.max(0,h(a.valor)-h(a.abonado??0))]))}function Uo(e){return e.baseCobro??(e.tipo==="porcentaje"?"cada_ingreso":"una_vez_por_cuenta")}function Qo(e,a,o){if(!o&&Uo(e)==="una_vez_por_cuenta")return!1;if(e.modo==="primer_pago")return a===1&&o;if(a<(e.desdePago??1))return!1;if(e.modo==="cada_pago")return!0;let t=e.supuesto??"siempre";return t==="nunca"?!1:t==="cada_dos_pagos"?a%2===1:!0}function ya(e,a,o){let t=e,n=0;for(let s of a??[]){let r=Math.max(1,Math.round(s.desdePago));o>=r&&r>=n&&(t=s.valor,n=r)}return t}function Jo(e,a,o){let t=ya(e.valor,e.cambios,o);return e.tipo==="porcentaje"?oe(a,t):h(t)}function Xo(e,a){return e.maximoPorPago&&e.maximoPorPago>0?h(e.maximoPorPago):e.enCuotas&&e.enCuotas>0?Math.max(1,Math.ceil(h(e.valor)/Math.round(e.enCuotas))):a}function U(e,a,o,t,n,s,r,i=!0){let l=h(a),d=[];for(let x of o){if(!Qo(x,e,i))continue;let E=Math.min(Jo(x,a,e),l);E<=0||(d.push({nombre:x.nombre,monto:E}),l-=E)}let m=ya(t.base,t.cambios,e),g=Math.min(h(m),l);l-=g;let f=[],v=0;for(let x of n){let E=s.get(x.id)??0;if(E<=0||e<(x.desdePago??1))continue;let D=Xo(x,E),S=Math.min(E,l,D);if(t.elastico&&S<E&&D>=E){let O=Math.max(0,g-h(t.minimo)),ae=E-S;ae<=O&&(g-=ae,v+=ae,S=E)}if(!(S<=0)&&(f.push({metaId:x.id,monto:S}),s.set(x.id,E-S),l-=Math.min(S,l),l<=0))break}let I=l;return{numero:e,ingreso:a,obligaciones:d,aColchon:g,recorteColchon:v,abonos:f,sobrante:I,saldoAhorro:r+g+I}}function xa(e,a,o,t,n,s,r=!0){let i=e.cuentaDeCobroId===void 0||e.cuentaDeCobroId==="",l=U(a,h(e.monto),i?[]:o,i?{...t,base:0,minimo:0}:t,n,s,0,r),d=new Map(n.map(m=>[m.id,m]));return{id:`rep-${e.id}`,ingresoId:e.id,obligaciones:l.obligaciones.map(m=>({nombre:m.nombre,monto:m.monto})),abonos:l.abonos.map(m=>({nombre:d.get(m.metaId)?.nombre??"(meta borrada)",monto:m.monto,refId:m.metaId})),alAhorro:l.aColchon+l.sobrante,propuesto:!0}}function Wo(e){let a=o=>o.reduce((t,n)=>t+h(n.monto),0);return a(e.obligaciones)+a(e.abonos)+a(e.gastos??[])+h(e.alAhorro)}function ne(e,a){return h(a.monto)-Wo(e)}var Ue=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function Sa(e){return e.slice(0,7)}function Q(e,a){let o=h(a.monto);if(o===0)return;let t=e.get(a.nombre);t?t.monto+=o:e.set(a.nombre,{...a,monto:o})}function Qe(e,a){let o=new Map(a.map(n=>[n.ingresoId,n])),t=new Map;for(let n of e){let s=Sa(n.fecha),r=t.get(s);r||(r={mes:s,entro:0,deTrabajo:0,deFuera:0,aObligaciones:0,aMetas:0,enGastos:0,alAhorro:0,detalle:[],sinAsignar:0,_detalle:new Map},t.set(s,r));let i=h(n.monto);r.entro+=i,n.cuentaDeCobroId===void 0||n.cuentaDeCobroId===""?r.deFuera+=i:r.deTrabajo+=i;let d=o.get(n.id);if(!d){r.sinAsignar+=i;continue}for(let m of d.obligaciones)r.aObligaciones+=h(m.monto),Q(r._detalle,m);for(let m of d.abonos)r.aMetas+=h(m.monto),Q(r._detalle,m);for(let m of d.gastos??[])r.enGastos+=h(m.monto),Q(r._detalle,m);r.alAhorro+=h(d.alAhorro),r.sinAsignar+=ne(d,n)}return[...t.values()].map(({_detalle:n,...s})=>({...s,detalle:[...n.values()].sort((r,i)=>i.monto-r.monto)})).sort((n,s)=>n.mes.localeCompare(s.mes))}function Pa(e){let a=new Map;for(let o of e)for(let t of[...o.obligaciones,...o.abonos,...o.gastos??[]])Q(a,t);return[...a.values()].sort((o,t)=>t.monto-o.monto)}function ye(e){let[a,o]=e.split("-"),t=Number(o)-1;return Ue[t]?`${Ue[t]} de ${a}`:e}function Ra(e,a,o,t=[]){let n=new Map,s=new Map,r=new Map(t.map(l=>[l.id,l.nombre])),i=l=>r.get(l)??l;for(let l of e){let d=Me(l.numero,a,Math.max(1,o)),m=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,g=n.get(m);g||(g={mes:m,entro:0,aObligaciones:0,aMetas:0,alAhorro:0,detalle:[],pagos:[]},n.set(m,g),s.set(m,new Map));let f=s.get(m);g.pagos.push(l.numero),g.entro+=h(l.ingreso);for(let v of l.obligaciones)g.aObligaciones+=h(v.monto),Q(f,{nombre:v.nombre,monto:v.monto});for(let v of l.abonos)g.aMetas+=h(v.monto),Q(f,{nombre:i(v.metaId),monto:v.monto,refId:v.metaId});g.alAhorro+=h(l.aColchon)+h(l.sobrante)}return[...n.values()].map(l=>({...l,detalle:[...s.get(l.mes).values()].sort((d,m)=>m.monto-d.monto)})).sort((l,d)=>l.mes.localeCompare(d.mes))}function Ca(e,a){let o=new Set(a.map(t=>t.cuentaDeCobroId).filter(t=>!!t));return e.cuentaDeCobroId?o.has(e.cuentaDeCobroId)?o.size:o.size+1:Math.max(1,o.size)}function _(e){return(e??[]).filter(a=>h(a.monto)!==0)}function Ia(e,a){let o=new Set([..._(a.obligaciones),..._(a.abonos)].map(t=>t.nombre));return[..._(e.obligaciones),..._(e.abonos)].map(t=>t.nombre).filter(t=>!o.has(t))}function Aa(e,a,o,t=new Map){return[...new Set([...e.map(s=>s.mes),...a.map(s=>s.mes)])].sort().map(s=>{let r=e.find(m=>m.mes===s)??null,i=a.find(m=>m.mes===s)??null,l=s<o?"pasado":s===o?"actual":"futuro",d=t.get(s)??(r?{monto:r.entro,segun:"escenario"}:null);return{mes:s,estado:l,real:i,simulado:r,esperado:d,diferencia:l==="pasado"&&d&&i?i.entro-d.monto:null}})}function Je(e){let a=0,o=0,t=0,n=0,s=0,r=0;for(let i of e)i.real&&(n+=1,a+=i.real.entro,o+=i.real.aObligaciones+i.real.aMetas+i.real.enGastos,t+=i.real.alAhorro),i.estado==="futuro"&&i.simulado&&(r+=1,s+=i.esperado?.monto??i.simulado.entro);return{mesesConDatos:n,entroDeVerdad:a,gastadoDeVerdad:o,guardadoDeVerdad:t,faltaPorEntrar:s,mesesQueFaltan:r}}var Ko=new Map(Ue.map((e,a)=>[e,String(a+1).padStart(2,"0")]));function Zo(e,a){let o=e.toLowerCase().trim(),t=o.match(/^(\d{4})-(\d{2})/);if(t)return`${t[1]}-${t[2]}`;let n=o.match(/([a-záéíóú]+)\D+(\d{4})/);if(n){let r=Ko.get(n[1]);if(r)return`${n[2]}-${r}`}let s=a.slice().sort((r,i)=>r.fecha.localeCompare(i.fecha))[0];return s?Sa(s.fecha):null}function La(e,a,o,t){let n=new Map;for(let s of e){let r=a.filter(l=>l.cuentaDeCobroId!==void 0),i=Zo(s.periodo,r);i&&n.set(i,h(s.montoEsperado))}return new Map(t.map(s=>{let r=n.get(s);return[s,r!==void 0?{monto:r,segun:"cuenta_de_cobro"}:{monto:h(o),segun:"escenario"}]}))}function wa(e,a){let o=s=>s.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),t=new Map(a.map(s=>[o(s.nombre),s])),n=[];for(let s of _(e.gastos)){let r=t.get(o(s.nombre));r&&n.push({gasto:s,metaId:r.id,metaNombre:r.nombre})}return n}function se(e,a){let o=new Map;for(let t of a)for(let n of t.abonos)n.refId&&o.set(n.refId,(o.get(n.refId)??0)+h(n.monto));return new Map(e.map(t=>{let n=h(t.valor),s=h(t.abonado??0),r=o.get(t.id)??0,i=Math.min(s+r,n);return[t.id,{previo:s,real:r,total:i,falta:Math.max(0,n-i)}]}))}function Ta(e,a){let o=se(e,a);return e.map(t=>({...t,abonado:o.get(t.id).total}))}function qa(e,a){let o=0;for(let t of se(e,a).values())o+=t.total;return o}var et=600;function re(e){let a=Ee(e.metas),o=e.maxPagos??et,t=[],n=new Map,s=new Map,r=new Map,i=new Map,l=0,d=0;for(;d<o&&[...a.values()].some(g=>g>0);){d+=1;let g=U(d,h(e.ingresoEsperado),e.obligaciones,e.colchon,e.metas,a,l);l=g.saldoAhorro,t.push(g);for(let f of g.abonos)n.has(f.metaId)||n.set(f.metaId,d),r.set(f.metaId,(r.get(f.metaId)??0)+1),i.set(f.metaId,(i.get(f.metaId)??0)+f.monto),(a.get(f.metaId)??0)<=0&&s.set(f.metaId,d)}let m=e.metas.map(g=>{let f=Math.min(h(g.abonado??0),h(g.valor)),v=i.get(g.id)??0;return{metaId:g.id,nombre:g.nombre,grupo:g.grupo,valor:g.valor,pagoInicio:n.get(g.id)??null,pagoFin:s.get(g.id)??null,cantidadPagos:r.get(g.id)??0,totalAbonado:f+v,completada:(a.get(g.id)??0)<=0,yaEstabaPagada:f>=h(g.valor)}});return{escenario:e.nombre,pagos:t,metas:m,totalPagos:d,ahorroFinal:l,incompleta:d>=o&&m.some(g=>!g.completada)}}function Oa(e){let a=new Map;for(let o of e.metas){if(!o.grupo)continue;let t=a.get(o.grupo)??[];t.push(o),a.set(o.grupo,t)}return[...a.entries()].map(([o,t])=>{let n=t.map(i=>i.pagoInicio).filter(i=>i!==null),s=t.map(i=>i.pagoFin).filter(i=>i!==null),r=t.every(i=>i.completada);return{grupo:o,valor:t.reduce((i,l)=>i+l.valor,0),pagoInicio:n.length?Math.min(...n):null,pagoFin:r&&s.length?Math.max(...s):null,totalAbonado:t.reduce((i,l)=>i+l.totalAbonado,0),completado:r,yaEstabaPagado:t.every(i=>i.yaEstabaPagada)}})}function ja(e,a){return a.filter(t=>t.antesDelPago&&t.antesDelPago>0).map(t=>{let n=e.metas.find(i=>i.metaId===t.id),s=n?.pagoFin??null,r=n?.yaEstabaPagada?0:s;return{metaId:t.id,nombre:t.nombre,queria:Math.round(t.antesDelPago),termina:r,seRetrasa:r===null?null:Math.max(0,r-Math.round(t.antesDelPago))}})}function Fa(e,a){let o=h(a);if(o<=0)return null;let t=re(e),n=re({...e,ingresoEsperado:h(e.ingresoEsperado)+o,maxPagos:1}),s=new Map(n.metas.map(l=>[l.metaId,l.totalAbonado])),i=1+re({...e,metas:e.metas.map(l=>({...l,abonado:Math.max(h(l.abonado??0),s.get(l.id)??0)}))}).totalPagos;return{pendiente:o,pagosAhora:t.totalPagos,pagosSiPagan:i,seAdelanta:Math.max(0,t.totalPagos-i)}}function Xe(e,a,o){return new Date(e,a-1,o)}function xe(e,a){let o=new Date(e.getTime());return o.setDate(o.getDate()+a),o}function at(e){let a=e.getDay();return a===1?e:xe(e,(8-a)%7)}function ot(e){let a=e%19,o=Math.floor(e/100),t=e%100,n=Math.floor(o/4),s=o%4,r=Math.floor((o+8)/25),i=Math.floor((o-r+1)/3),l=(19*a+o-n-i+15)%30,d=Math.floor(t/4),m=t%4,g=(32+2*s+2*d-l-m)%7,f=Math.floor((a+11*l+22*g)/451),v=Math.floor((l+g-7*f+114)/31),I=(l+g-7*f+114)%31+1;return Xe(e,v,I)}function tt(e){let a=ot(e),o=s=>xe(a,s),t=[[1,1,"A\xF1o Nuevo"],[5,1,"D\xEDa del Trabajo"],[7,20,"Independencia de Colombia"],[8,7,"Batalla de Boyac\xE1"],[12,8,"Inmaculada Concepci\xF3n"],[12,25,"Navidad"]],n=[[1,6,"Reyes Magos"],[3,19,"San Jos\xE9"],[6,29,"San Pedro y San Pablo"],[8,15,"Asunci\xF3n de la Virgen"],[10,12,"D\xEDa de la Raza"],[11,1,"Todos los Santos"],[11,11,"Independencia de Cartagena"]];return[...t.map(([s,r,i])=>({fecha:Xe(e,s,r),nombre:i})),...n.map(([s,r,i])=>({fecha:at(Xe(e,s,r)),nombre:i})),{fecha:o(-3),nombre:"Jueves Santo"},{fecha:o(-2),nombre:"Viernes Santo"},{fecha:o(43),nombre:"Ascensi\xF3n del Se\xF1or"},{fecha:o(64),nombre:"Corpus Christi"},{fecha:o(71),nombre:"Sagrado Coraz\xF3n de Jes\xFAs"}].sort((s,r)=>s.fecha.getTime()-r.fecha.getTime())}var ie=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`;function We(e){return tt(e.getFullYear()).find(a=>ie(a.fecha)===ie(e))?.nombre??null}function nt(e){return We(e)!==null}function Ke(e){return e.getDay()===0}function _a(e){let a=new Date(e.getTime());for(let o=0;o<15&&(Ke(a)||nt(a));o++)a=xe(a,-1);return a}var Na=30,ka="Febrero no tiene 30: se radica el \xFAltimo d\xEDa del mes (28, o 29 si es bisiesto), y si ese d\xEDa cae domingo o festivo se retrocede igual que siempre.";function st(e,a){let o=new Date(e,a,0).getDate(),t=o<Na,n=new Date(e,a-1,Math.min(Na,o)),s=_a(n),r=null;if(ie(s)!==ie(n)){let i=We(n);r=i?`el ${n.getDate()} es festivo (${i})`:Ke(n)?`el ${n.getDate()} cae domingo`:`el ${n.getDate()} no es d\xEDa h\xE1bil`}return{fecha:s,fechaOriginal:n,motivoDelCambio:r,usoUltimoDiaDelMes:t}}var Ze=[{id:"cuenta",nombre:"Cuenta de cobro diligenciada",frecuencia:"cada_mes",detalle:"Con una descripci\xF3n del servicio prestado."},{id:"informe",nombre:"Informe de actividades",frecuencia:"cada_mes",detalle:"Detallando espec\xEDficamente las funciones o actividades realizadas."},{id:"conformidad",nombre:"Certificado de conformidad del servicio",frecuencia:"cada_mes",detalle:"Lo entrega el coordinador o l\xEDder del \xE1rea: hay que ped\xEDrselo con tiempo."},{id:"seguridad_social",nombre:"Planilla de seguridad social",frecuencia:"cada_mes",obligatorioExplicito:!0,detalle:"Liquidada del mes VENCIDO al que se est\xE1 cobrando. La circular la marca como obligatoria."},{id:"constancia",nombre:"Constancia de prestaci\xF3n de servicio firmada por el paciente",frecuencia:"solo_asistencial",detalle:"Solo personal asistencial. Como t\xE9cnico de sistemas, no aplica."},{id:"rut",nombre:"RUT actualizado",frecuencia:"una_sola_vez",detalle:"No superior a 30 d\xEDas. Solo la primera vez."},{id:"bancaria",nombre:"Certificaci\xF3n bancaria",frecuencia:"una_sola_vez",detalle:"No superior a 30 d\xEDas. Solo la primera vez, o si cambia de cuenta."}];function Se(){return Ze.filter(e=>e.frecuencia==="cada_mes")}var rt=5;function it(e,a){let o=new Date(e.getFullYear(),e.getMonth(),e.getDate()).getTime(),t=new Date(a.getFullYear(),a.getMonth(),a.getDate()).getTime();return Math.round((t-o)/864e5)}var za=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function ea(e,a=[]){let o=st(e.getFullYear(),e.getMonth()+1),t=it(e,o.fecha),n=t<0?"vencido":t===0?"hoy":t<=rt?"pronto":"tranquilo",s=o.fecha.getDate(),r=za[o.fecha.getMonth()],i=n==="vencido"?`Se pas\xF3 la fecha: hab\xEDa que radicar el ${s} de ${r}`:n==="hoy"?"HOY es el \xFAltimo d\xEDa para radicar la cuenta de cobro":n==="pronto"?`Faltan ${t} d\xEDas: radicas el ${s} de ${r}`:`La cuenta de cobro se radica el ${s} de ${r}`,l=Se().filter(d=>!a.includes(d.id)).map(d=>d.id);return{limite:o,diasQueFaltan:t,urgencia:n,titular:i,soportesPendientes:l}}function Ha(e){let a=e.fecha.getDate(),o=za[e.fecha.getMonth()];return e.motivoDelCambio?`Se radica el ${a} de ${o}, no el ${e.fechaOriginal.getDate()}, porque ${e.motivoDelCambio}.`:`Se radica el ${a} de ${o}.`}function Pe(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`}function ct(){return new Date().toISOString().slice(0,10)}function lt(){return[]}function N(){return{version:1,escenario:{nombre:"Mi escenario",ingresoEsperado:2e6,colchonBase:1e5,colchonMinimo:0,colchonElastico:!1,fechaPrimerPago:ct(),diasOptimista:30,diasPesimista:60},obligaciones:lt(),metas:[],cuentas:[],ingresos:[],repartos:[],soportesMarcados:{}}}function k(e){return`${e}-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`}var Ba="gestiondinerotrabajo.estado";function Va(e){let a=N();if(typeof e!="object"||e===null)return a;let o=e;return{version:1,escenario:{...a.escenario,...o.escenario??{}},obligaciones:o.obligaciones??a.obligaciones,metas:o.metas??a.metas,cuentas:o.cuentas??a.cuentas,ingresos:o.ingresos??a.ingresos,repartos:o.repartos??a.repartos,soportesMarcados:o.soportesMarcados??a.soportesMarcados}}function Ga(){let e=null;try{e=localStorage.getItem(Ba)}catch{return{estado:N(),aviso:{texto:"No pude leer los datos guardados. Est\xE1s viendo un inicio en blanco.",grave:!0}}}if(!e)return{estado:N(),aviso:null};try{return{estado:Va(JSON.parse(e)),aviso:null}}catch{return{estado:N(),aviso:{texto:"Los datos guardados est\xE1n da\xF1ados. No los borr\xE9: sigue ah\xED el archivo por si se puede recuperar.",grave:!0}}}}function ce(e){try{return localStorage.setItem(Ba,JSON.stringify(e)),null}catch(a){return a instanceof Error?a.message:"no se pudo guardar"}}function Ya(e){return JSON.stringify(e,null,2)}function aa(e){try{return{estado:Va(JSON.parse(e)),aviso:null}}catch{return{estado:null,aviso:{texto:"Ese archivo no es un respaldo v\xE1lido. No cambi\xE9 nada de lo que ten\xEDas.",grave:!0}}}}var oa=null;function J(e){return oa?.(),new Promise(a=>{let o=document.createElement("div");o.className="capa-dialogo",o.innerHTML=`
      ...
      </div>`;let t=o.querySelector(".dlg-campo"),n=i=>{document.removeEventListener("keydown",r,!0),o.remove(),oa=null,a(i)},s=()=>n(t.value);function r(i){i.key==="Escape"&&(i.preventDefault(),n(null)),i.key==="Enter"&&document.activeElement===t&&(i.preventDefault(),s())}o.querySelector(".dlg-aceptar").addEventListener("click",s),o.querySelector(".dlg-cancelar").addEventListener("click",()=>n(null)),o.addEventListener("mousedown",i=>{i.target===o&&n(null)}),document.addEventListener("keydown",r,!0),document.body.appendChild(o),oa=()=>n(null),t.focus(),t.select()})}function Re(e){return e.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}var Ua=new Intl.NumberFormat("es-CO",{maximumFractionDigits:0});function ta(e){return e.replace(/\D/g,"")}function ut(e){let a=ta(e);if(a==="")return"";let o=a.replace(/^0+(?=\d)/,"");return Ua.format(Number(o))}function L(e){let a=ta(e);return a===""?0:Number(a)}function R(e){return Ua.format(Math.round(e))}function Qa(e){let a=e.value,o=e.selectionStart??a.length,t=ta(a.slice(0,o)).length,n=ut(a);if(n===a)return;e.value=n;let s=0,r=0;for(;r<n.length&&s<t;)/\d/.test(n[r])&&s++,r++;e.setSelectionRange(r,r)}function Ja(e,a){let o=[],t=0;for(let n of a){let s=Math.max(1,Math.round(n)||1),r=e[t];o.push(s>1||!r?null:r),t+=s}return o}var pt=4;function Xa(e){return e.length>=pt}var z="__borrado";function le(e,a){return e[a]??""}function X(e){if(e==null)return"null";if(Array.isArray(e))return`[${e.map(X).join(",")}]`;if(typeof e=="object"){let a=e;return`{${Object.keys(a).filter(t=>a[t]!==void 0).sort().map(t=>`${JSON.stringify(t)}:${X(a[t])}`).join(",")}}`}return JSON.stringify(e)}function Ce(e,a){return X(e)===X(a)}function Wa(e,a,o,t){return e!==o?e>o:X(a)>=X(t)}function Ka(e,a,o,t={}){let n={...t},s=new Set([...Object.keys(e??{}),...Object.keys(a)]);for(let r of s){if(r==="id")continue;let i=e===null?void 0:e[r],l=a[r];Ce(i,l)||(n[r]=o)}return n}function mt(e,a){if(e.datos.id!==a.datos.id)throw new Error(`No se pueden fusionar dos filas distintas: ${e.datos.id} y ${a.datos.id}.`);let o=new Set([...Object.keys(e.datos),...Object.keys(a.datos)]),t={id:e.datos.id},n={},s=[];for(let g of o){if(g==="id")continue;let f=e.datos[g],v=a.datos[g],I=le(e.tocado,g),x=le(a.tocado,g),E=Wa(I,f,x,v),D=E?f:v,S=E?v:f;D!==void 0&&(t[g]=D);let O=I>x?I:x;O!==""&&(n[g]=O),Ce(f,v)||s.push({id:e.datos.id,campo:g,valor:S,cuando:E?x:I,gano:D})}let r=le(e.tocado,z),i=le(a.tocado,z),l=Wa(r,e.borradoEn,i,a.borradoEn),d=l?e.borradoEn:a.borradoEn,m=r>i?r:i;return m!==""&&(n[z]=m),Ce(e.borradoEn,a.borradoEn)||s.push({id:e.datos.id,campo:z,valor:l?a.borradoEn:e.borradoEn,cuando:l?i:r,gano:d}),{fila:{datos:t,tocado:n,borradoEn:d??null},descartes:s}}function gt(e,a){let o=e.datos.propuesto,t=a.datos.propuesto;return o===!1&&t===!0?e:t===!1&&o===!0?a:null}function bt(e,a){let o=new Set([...Object.keys(e.datos),...Object.keys(a.datos)]),t=[];for(let n of o){if(n==="id")continue;let s=e.datos[n],r=a.datos[n];JSON.stringify(s)!==JSON.stringify(r)&&t.push({id:e.datos.id,campo:n,valor:r,cuando:le(a.tocado,n),gano:s})}return t}function Za(e,a){let o=new Map(a.map(s=>[s.datos.id,s])),t=[],n=[];for(let s of e){let r=o.get(s.datos.id);if(!r){t.push(s);continue}let i=gt(s,r);if(i){t.push(i),n.push(...bt(i,i===s?r:s)),o.delete(s.datos.id);continue}let l=mt(s,r);t.push(l.fila),n.push(...l.descartes),o.delete(s.datos.id)}for(let s of a)o.has(s.datos.id)&&t.push(s);return{filas:t,descartes:n}}function eo(e,a){return a?e.filter(o=>{let t=a.get(o.id);if(!t)return!0;let n=o.campo===z?t.borradoEn:t.datos[o.campo];return!Ce(o.valor,n)}):e}var na=["escenario","obligaciones","metas","cuentas","ingresos","repartos","soportes"],ft="escenario";function H(e,a){return{datos:{...a,id:e},tocado:{},borradoEn:null}}function Ie(e){return{escenario:[H(ft,{...e.escenario})],obligaciones:e.obligaciones.map(a=>H(a.id,{...a})),metas:e.metas.map(a=>H(a.id,{...a})),cuentas:e.cuentas.map(a=>H(a.id,{...a})),ingresos:e.ingresos.map(a=>H(a.id,{...a})),repartos:e.repartos.map(a=>H(a.id,{...a})),soportes:Object.entries(e.soportesMarcados).map(([a,o])=>H(a,{marcados:o}))}}function ao(e,a){let o=r=>(e[r]??[]).filter(i=>i.borradoEn===null),t=r=>e[r]!==void 0&&e[r].length>0,n=t("escenario")?{...a.escenario,...o("escenario")[0]?.datos}:a.escenario;n&&"id"in n&&delete n.id;let s={};for(let r of o("soportes")){let i=r.datos.marcados;s[r.datos.id]=Array.isArray(i)?i:[]}return{version:a.version,escenario:n,obligaciones:t("obligaciones")?o("obligaciones").map(r=>r.datos):a.obligaciones,metas:t("metas")?o("metas").map(r=>r.datos):a.metas,cuentas:t("cuentas")?o("cuentas").map(r=>r.datos):a.cuentas,ingresos:t("ingresos")?o("ingresos").map(r=>r.datos):a.ingresos,repartos:t("repartos")?o("repartos").map(r=>r.datos):a.repartos,soportesMarcados:t("soportes")?s:a.soportesMarcados}}function oo(e){return{id:e.datos.id,datos:e.datos,tocado:e.tocado,borrado_en:e.borradoEn}}function to(e){let a=e.datos??{};return{datos:{...a,id:String(e.id??a.id??"")},tocado:e.tocado??{},borradoEn:e.borrado_en??null}}function no(e,a,o,t={}){let n=Ie(e),s=a?Ie(a):null,r={};for(let i of na){let l=new Map((s?.[i]??[]).map(f=>[f.datos.id,f])),d=t[i]??new Map,m=n[i].map(f=>({...f,tocado:Ka(l.get(f.datos.id)?.datos??null,f.datos,o,d.get(f.datos.id)??{})})),g=new Set(n[i].map(f=>f.datos.id));for(let[f,v]of l)g.has(f)||m.push({datos:v.datos,tocado:{...d.get(f)??{},[z]:o},borradoEn:o});r[i]=m}return r}var B={url:"https://voncmkjcxzgxfloehovb.supabase.co",clave:"sb_publishable_Ev68VoFXNXqvcVOjgXoknw_vAFK-iHn"},sa="gestiondinerotrabajo.sesion",ra="gestiondinerotrabajo.ultimaSincronizacion",Ae="gestiondinerotrabajo.nube.sincronizado";function Le(){try{let e=localStorage.getItem(sa);return e?JSON.parse(e):null}catch{return null}}function ia(e){try{e?localStorage.setItem(sa,JSON.stringify(e)):localStorage.removeItem(sa)}catch{}}function ca(){ia(null);try{localStorage.removeItem(ra),localStorage.removeItem(Ae)}catch{}}function so(){try{let e=localStorage.getItem(Ae);return e?JSON.parse(e):null}catch{return null}}function ro(e){try{e?localStorage.setItem(Ae,JSON.stringify(e)):localStorage.removeItem(Ae)}catch{}}async function io(e,a){let o=await fetch(`${B.url}/auth/v1/token?grant_type=password`,{method:"POST",headers:{apikey:B.clave,"Content-Type":"application/json"},body:JSON.stringify({email:e.trim(),password:a})}),t=await o.json().catch(()=>({}));if(!o.ok)throw new Error(ht(o.status,t));let n={token:t.access_token,refresco:t.refresh_token,usuarioId:t.user?.id??"",correo:t.user?.email??e.trim(),caduca:Date.now()+(Number(t.expires_in)||3600)*1e3};if(!n.token||!n.usuarioId)throw new Error("Supabase respondi\xF3 sin sesi\xF3n. Revisa la direcci\xF3n del proyecto.");return ia(n),n}function ht(e,a){let o=String(a.error_description??a.msg??a.message??"");return e===400&&/invalid login|credentials/i.test(o)?"Correo o contrase\xF1a incorrectos.":e===400&&/email not confirmed/i.test(o)?"Falta confirmar el correo: mira el mensaje que te mand\xF3 Supabase.":e===422?"Ese correo no tiene un formato v\xE1lido.":e===429?"Demasiados intentos seguidos. Espera un momento.":o||`No se pudo entrar (error ${e}).`}async function vt(){let e=Le();if(!e)throw new Error("No has entrado con tu correo.");if(Date.now()<e.caduca-6e4)return e;let a=await fetch(`${B.url}/auth/v1/token?grant_type=refresh_token`,{method:"POST",headers:{apikey:B.clave,"Content-Type":"application/json"},body:JSON.stringify({refresh_token:e.refresco})});if(!a.ok)throw ca(),new Error("La sesi\xF3n caduc\xF3. Vuelve a entrar con tu correo.");let o=await a.json(),t={...e,token:o.access_token,refresco:o.refresh_token??e.refresco,caduca:Date.now()+(Number(o.expires_in)||3600)*1e3};return ia(t),t}function co(e){return{apikey:B.clave,Authorization:`Bearer ${e.token}`,"Content-Type":"application/json"}}async function $t(e,a,o){let t=o?`&actualizado_en=gt.${encodeURIComponent(o)}`:"",n=await fetch(`${B.url}/rest/v1/${a}?select=*${t}`,{headers:co(e)});if(!n.ok)throw new Error(await lo(n,a,"bajar"));return(await n.json()).map(to)}async function Mt(e,a,o){if(o.length===0)return;let t=o.map(s=>({...oo(s),usuario_id:e.usuarioId})),n=await fetch(`${B.url}/rest/v1/${a}?on_conflict=usuario_id,id`,{method:"POST",headers:{...co(e),Prefer:"resolution=merge-duplicates,return=minimal"},body:JSON.stringify(t)});if(!n.ok)throw new Error(await lo(n,a,"subir"))}async function lo(e,a,o){let t=await e.text().catch(()=>"");return e.status===401?"La sesi\xF3n caduc\xF3. Vuelve a entrar con tu correo.":e.status===404||/does not exist/i.test(t)?`Falta la tabla \xAB${a}\xBB en Supabase: ejecuta supabase/esquema.sql.`:e.status===403||/permission denied/i.test(t)?`Sin permiso sobre \xAB${a}\xBB. Revisa los grants del esquema.`:`No se pudo ${o} \xAB${a}\xBB (error ${e.status}).`}async function uo(e,a,o){let t=await vt(),n=we(),s=no(e,a,o),r=a?Ie(a):null,i={},l=[];for(let m of na){let g=s[m],f=await $t(t,m,n),v=Za(g,f);i[m]=v.filas;let I=r?new Map(r[m].map(D=>[D.datos.id,{datos:D.datos,borradoEn:D.borradoEn}])):null,x=new Map(v.filas.map(D=>[D.datos.id,D.datos]));l.push(...eo(v.descartes,I).map(D=>{let S=x.get(D.id),O=typeof S?.nombre=="string"?S.nombre:typeof S?.periodo=="string"?S.periodo:void 0;return{...D,tabla:m,nombre:O}}));let E=new Set(g.filter(D=>Object.keys(D.tocado).length>0).map(D=>D.datos.id));for(let D of v.descartes)E.add(D.id);await Mt(t,m,v.filas.filter(D=>E.has(D.datos.id)))}let d=new Date().toISOString();try{localStorage.setItem(ra,d)}catch{}return{estado:ao(i,e),descartes:l,cuando:d}}function we(){try{return localStorage.getItem(ra)}catch{return null}}var Oe="__borrado",qe=new Intl.NumberFormat("es-CO"),Dt={obligaciones:"obligaciones",abonos:"abonos a metas",gastos:"gastos",cambios:"cambios de valor",valor:"valor",nombre:"nombre",grupo:"grupo",abonado:"ya pagado antes",alAhorro:"al ahorro",monto:"monto",fecha:"fecha",ingresoEsperado:"ingreso esperado",fechaPrimerPago:"fecha del primer pago",marcados:"soportes marcados",clase:"compra o deuda"};function la(e,a){switch(e.tabla){case"metas":{let o=a.metas.find(t=>t.id===e.id)?.nombre??e.nombre;return o!==void 0?`la meta \xAB${o}\xBB`:"una meta que ya no est\xE1"}case"obligaciones":{let o=a.obligaciones.find(t=>t.id===e.id)?.nombre??e.nombre;return o!==void 0?`la obligaci\xF3n \xAB${o}\xBB`:"una obligaci\xF3n que ya no est\xE1"}case"cuentas":{let o=a.cuentas.find(t=>t.id===e.id);return o?`la cuenta de cobro de ${o.periodo}`:"una cuenta de cobro que ya no est\xE1"}case"ingresos":{let o=a.ingresos.find(t=>t.id===e.id);return o?`el pago del ${o.fecha} (${qe.format(o.monto)})`:"un pago que ya no est\xE1"}case"repartos":{let o=a.repartos.find(n=>n.id===e.id),t=o?a.ingresos.find(n=>n.id===o.ingresoId):void 0;return t?`el reparto del pago del ${t.fecha} (${qe.format(t.monto)})`:"un reparto de un pago que ya no est\xE1"}case"escenario":return"el escenario";case"soportes":return`los soportes de ${e.id}`}}function da(e){return e===Oe?"borrado":Dt[e]??e}function je(e,a){return e===Oe?a?"borrada":"sin borrar":Te(a)}function Te(e){if(e==null||e==="")return"\u2014";if(typeof e=="number")return qe.format(e);if(typeof e=="boolean")return e?"s\xED":"no";if(typeof e=="string")return e;if(Array.isArray(e))return e.length===0?"nada":e.map(Te).join(" \xB7 ");if(typeof e=="object"){let a=e;if(typeof a.nombre=="string"&&typeof a.monto=="number")return`${a.nombre} ${qe.format(a.monto)}`;if(typeof a.desdePago=="number"&&"valor"in a)return`desde el pago ${a.desdePago}: ${Te(a.valor)}`;let o=Object.keys(a).sort().filter(t=>a[t]!==void 0).map(t=>`${da(t)}: ${Te(a[t])}`);return o.length?o.join(", "):"\u2014"}return String(e)}var de=[{id:"inicio",rotulo:"Inicio",icono:"\u{1F3E0}",paneles:["inicio","radicacion"]},{id:"calendario",rotulo:"Calendario",icono:"\u{1F5D3}\uFE0F",paneles:["vista"]},{id:"metas",rotulo:"Metas",icono:"\u{1F3AF}",paneles:["metas","proyeccion"]},{id:"registrar",rotulo:"Registrar",icono:"\u{1F4B5}",paneles:["cuentas","real"]},{id:"ajustes",rotulo:"Ajustes",icono:"\u2699\uFE0F",paneles:["escenario","obligaciones","nube"]}],Et="inicio";function po(e){return de.find(a=>a.paneles.includes(e))?.id??null}function Fe(e){return de.some(a=>a.id===e)?e:Et}var mo=new Intl.NumberFormat("es-CO"),ua=e=>`$${mo.format(Math.round(e))}`;function go(e,a,o){let t=[];return t.push(`${e.clase==="deuda"?"\u26A0\uFE0F ":""}${e.nombre.trim()||"(sin nombre)"}`),t.push(ua(e.valor)),e.compra?t.push("ya la compraste"):a?.yaEstabaPagada?t.push("ya est\xE1 pagada"):o?t.push(o):t.push("sin fecha todav\xEDa"),t.join(" \xB7 ")}function bo(e,a){let o=e.tipo==="porcentaje"?`${yt(e.valor*100)} %${a?` = ${ua(a)}`:""}`:ua(e.valor),t=e.modo==="cada_pago"?"cada pago":e.modo==="puntual"?"puntual":e.modo==="primer_pago"?"solo el primero":String(e.modo),n=[e.nombre.trim()||"(sin nombre)",o,t];return(e.cambios?.length??0)>0&&n.push(`${e.cambios.length} cambio${e.cambios.length===1?"":"s"}`),n.join(" \xB7 ")}function yt(e){return Number.isInteger(e)?String(e):mo.format(Math.round(e*10)/10)}function fo(e,a){let o=new Map(a.map(s=>[s.metaId,s])),t=e.filter(s=>!s.compra&&!o.get(s.id)?.yaEstabaPagada&&s.valor>0),n=null;for(let s of t){let r=o.get(s.id)?.pagoFin??null;r!==null&&(!n||r<n.pagoFin)&&(n={meta:s,pagoFin:r})}return n||(t.length>0?{meta:t[0],pagoFin:null}:null)}function pa(e,a){return e.compra||e.valor<=0?1:Math.max(0,Math.min(1,a/e.valor))}function ho(e){let a=e.find(n=>n.numero===2)??e[0];if(!a||a.ingreso<=0)return null;let o=a.obligaciones.reduce((n,s)=>n+s.monto,0),t=a.abonos.reduce((n,s)=>n+s.monto,0);return{numero:a.numero,ingreso:a.ingreso,obligaciones:o,metas:t,ahorro:a.aColchon+a.sobrante}}function vo(e,a){let o=2*Math.PI*a,t=e.reduce((s,r)=>s+Math.max(0,r),0),n=0;return e.map(s=>{let r=t>0?Math.max(0,s)/t*o:0,i={largo:r,desde:n};return n+=r,i})}function $o(e,a){if(a.campo===Oe)return{ok:!1,motivo:"Un borrado no se puede deshacer desde aqu\xED: vuelve a crear esa fila."};if(a.campo==="id")return{ok:!1,motivo:"El identificador de una fila no se cambia."};let o=St(e,a);if(!o)return{ok:!1,motivo:"Eso ya no est\xE1 en este aparato."};let t=xt(a);return a.valor===void 0?delete o[t]:o[t]=a.valor,{ok:!0}}function xt(e){return e.tabla==="soportes"?e.id:e.campo}function St(e,a){let o=t=>t.find(n=>n.id===a.id)??null;switch(a.tabla){case"escenario":return e.escenario;case"metas":return o(e.metas);case"obligaciones":return o(e.obligaciones);case"cuentas":return o(e.cuentas);case"ingresos":return o(e.ingresos);case"repartos":return o(e.repartos);case"soportes":return a.campo!=="marcados"?null:e.soportesMarcados;default:return null}}var Pt=new Intl.NumberFormat("es-CO"),u=e=>`$${Pt.format(Math.round(e))}`,c,M=null;function K(e=new Date){let a=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${e.getFullYear()}-${a}-${o}`}function p(e){return e.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}var b=new Map;function Eo(e){if(!(e instanceof HTMLInputElement)&&!(e instanceof HTMLSelectElement))return null;let a=[e.id&&`#${e.id}`,e.dataset.accion&&`[data-accion="${e.dataset.accion}"]`,e.dataset.id&&`[data-id="${e.dataset.id}"]`,e.dataset.campo&&`[data-campo="${e.dataset.campo}"]`,e.dataset.tipo&&`[data-tipo="${e.dataset.tipo}"]`,e.dataset.i!==void 0&&`[data-i="${e.dataset.i}"]`].filter(Boolean);return a.length>0?a.join(""):null}var _e=null,ga=null,pe=!1,W=!1;var He=null,w=null,Rt=6,ze=!1;function Ct(e){let o=window.innerHeight;e<90?window.scrollBy({top:-Math.max(6,(90-e)/3),behavior:"instant"}):e>o-90&&window.scrollBy({top:Math.max(6,(e-(o-90))/3),behavior:"instant"})}function yo(e,a){return document.elementFromPoint(e,a)?.closest?.("tr[data-fila]")??null}function It(e){for(let a of document.querySelectorAll(".destino"))a.classList.remove("destino");e&&Number(e.dataset.fila)!==w?.desde&&e.classList.add("destino")}function xo(){w?.fila.classList.remove("arrastrando");for(let e of document.querySelectorAll(".destino"))e.classList.remove("destino");w=null}document.addEventListener("pointerdown",e=>{let a=e.target?.closest?.(".asa"),o=a?.closest("tr[data-fila]");!a||!o||(w={desde:Number(o.dataset.fila),fila:o,movido:!1,y0:e.clientY},o.classList.add("arrastrando"),a.setPointerCapture?.(e.pointerId),e.preventDefault())});document.addEventListener("pointermove",e=>{w&&(!w.movido&&Math.abs(e.clientY-w.y0)<Rt||(w.movido=!0,e.preventDefault(),Ct(e.clientY),It(yo(e.clientX,e.clientY))))});document.addEventListener("pointerup",e=>{if(!w)return;let{desde:a,movido:o}=w,t=yo(e.clientX,e.clientY);if(xo(),!o||!t)return;ze=!0,setTimeout(()=>{ze=!1},0);let n=Number(t.dataset.fila);if(!Number.isInteger(n)||n===a)return;let[s]=c.metas.splice(a,1);c.metas.splice(n,0,s),M={texto:`\xAB${s.nombre}\xBB qued\xF3 en la posici\xF3n ${n+1}. Ojo: en las metas el orden es la prioridad de pago, as\xED que las fechas de abajo cambiaron.`,malo:!1},$()});document.addEventListener("pointercancel",()=>{w&&(xo(),P())});document.addEventListener("mousedown",e=>{let a=e.target;pe=a?.closest("button[data-accion]")!==null&&a?.closest("button[data-accion]")!==void 0,_e=Eo(a?.closest("input, select")??null),ga=a?.closest?.("[data-panel]")?.dataset.panel??null},!0);document.addEventListener("mouseup",()=>{setTimeout(()=>{pe=!1,ga=null,W&&(W=!1,fa())},0)},!0);function At(e,a){let o=_e!==null,t=_e??e;if(_e=null,!t)return;let n=document.querySelector(t);if(n&&(n.focus(),!o&&a!==null&&typeof n.setSelectionRange=="function"))try{n.setSelectionRange(a,a)}catch{}}function q(){So()||fa()}function $(){So()||P()}function So(){let e=ce(c);return e&&(M={texto:`No pude guardar: ${e}`,malo:!0}),pe?(W=!0,!0):!1}function C(){let e=c.escenario;return{desde:new Date(`${e.fechaPrimerPago}T12:00:00`),diasOptimista:e.diasOptimista,diasPesimista:e.diasPesimista}}function Po(){let e=c.escenario;return{nombre:e.nombre,ingresoEsperado:e.ingresoEsperado,obligaciones:c.obligaciones,colchon:{nombre:"Otros / Ahorro",base:e.colchonBase,minimo:e.colchonMinimo,elastico:e.colchonElastico,cambios:e.cambiosColchon},metas:Ta(c.metas,c.repartos)}}function Lt(){return`${(c.escenario.cambiosColchon??[]).map((a,o)=>{let t=j(A(Math.max(1,a.desdePago),C()).optimista);return`<div class="cambio">
    ...
    </div>`}).join("")}<button class="chico" data-accion="nuevo-cambio-ahorro">+ cambio</button>`}function wt(){let e=c.escenario;return`
  <section class="panel">
    ...
    ${e.diasPesimista>e.diasOptimista?`<p class="nota rango">
      ...
      Con ${e.diasPesimista} d\xEDas, el pago ${Ye(C())?10:12} caer\xEDa
      ${(()=>{let a=C();return`<strong>${Math.round(11*(e.diasPesimista-e.diasOptimista)/30)} meses</strong> m\xE1s tarde que si fueran puntuales`})()}.
    </p>`:""}
  </section>`}var Tt={cada_pago:"Cada pago",primer_pago:"Solo el primer pago",puntual:"Puntual: cuando yo la marque"},Ro={siempre:"asumo que la pago siempre",cada_dos_pagos:"asumo un pago s\xED y otro no",nunca:"asumo que no la pago"};function Co(e,a,o){let t=e??1,n=j(A(t,C()).optimista);return`<input type="number" min="1" step="1" value="${t}" class="corto"
             data-accion="${a}" data-id="${o}" data-campo="desdePago" />
          <span class="rango mes-de-pago">${t<=1?"desde el primero":p(n)}</span>`}function Be(){let e=c.cuentas.filter(a=>a.montoEsperado>0);if(e.length>0){let a=e.reduce((o,t)=>t.periodo.localeCompare(o.periodo)>0?t:o);return{monto:a.montoEsperado,de:a.periodo,esReal:!0}}return{monto:c.escenario.ingresoEsperado,de:"lo que esperas por pago",esReal:!1}}function qt(e){let a=Be();if(a.monto<=0)return'<span class="rango">\u2014</span>';let o=e.tipo==="porcentaje"?oe(a.monto,e.valor):e.valor;return`<span class="calculado">${u(o)}</span>`}function Ot(e){let a=e.cambios??[];if(a.length===0)return"";let o=e.tipo==="porcentaje",t=(n,s)=>{let r=j(A(Math.max(1,n.desdePago),C()).optimista);return`<span class="cambio">
    ...
    <td colspan="9"><span class="rango">${p(e.nombre)} \xB7</span>
      ${a.map(t).join("")}</td>
  </tr>`}function jt(e){let a=e.modo==="puntual",o=Be(),t=o.monto>0&&e.tipo==="porcentaje"?oe(o.monto,e.valor):null;return`
  <tr data-id-fila="${e.id}" data-resumen="${p(bo(e,t))}"
      class="${e.id===He?"abierta":""}">
  ...
  </tr>`}function ma(e,a){return U(e,a,c.obligaciones,{nombre:"",base:0,minimo:0,elastico:!1},[],new Map,0).obligaciones.reduce((t,n)=>t+n.monto,0)}function Ft(){let e=Be();if(e.monto<=0)return"";let a=ma(1,e.monto),o=ma(2,e.monto),t=(s,r)=>`
  ...
  <p class="nota ${e.esReal?"":"aviso"}">${n}</p>`}function _t(){let e=c.obligaciones.filter(a=>a.modo==="puntual");return c.obligaciones.length===0?`
    <section class="panel">
  ...
  <section class="panel">
    ...
    <div class="tabla-ancha">
      <table>
        ...
        <tbody>${c.obligaciones.map(a=>jt(a)+Ot(a)).join("")}</tbody>
      </table>
    </div>
    ${Ft()}
    ...
    ${e.length?`<p class="nota aviso">
      ...
      ${e.map(a=>`<strong>${p(a.nombre)}</strong>: ${Ro[a.supuesto??"siempre"]}`).join(" \xB7 ")}.
    </p>`:""}
  </section>`}function Nt(e){if(!e.compra)return`<button data-accion="comprada" data-id="${e.id}">Ya la compr\xE9</button>`;let a=e.compra.precioReal-e.valor;return`<span class="completa">${p(ye(e.compra.mes))}</span>
    <span class="rango">${u(e.compra.precioReal)}${a===0?"":a<0?` \xB7 ${u(-a)} menos`:` \xB7 ${u(a)} m\xE1s`}</span>
    <button class="icono" data-accion="no-comprada" data-id="${e.id}" title="No la compr\xE9">\u2715</button>`}function kt(e){let a=se(c.metas,c.repartos).get(e.id),o=a.previo>0&&a.real>0&&Math.abs(a.previo-a.real)<=Math.max(1e3,a.real*.05),t=`<input type="text" inputmode="numeric" data-dinero value="${R(a.previo)}"
    ...
    ${o?`<span class="aviso">\u26A0\uFE0F ${u(a.previo)} escrito a mano y ${u(a.real)}
      ...
      <button class="icono" data-accion="quitar-previo" data-id="${e.id}"
        title="S\xED, dejar solo lo registrado">\u2713</button></span>`:""}`}function Io(e){return`<span class="solo-telefono plegado-todo">
  ...
  </span>`}function Ao(e){if((e==="metas"?c.metas.length:c.obligaciones.length)<2)return"";let o=e==="metas"?' title="Ojo: en las metas el orden es la prioridad de pago, as\xED que esto cambia el plan"':"";return`&nbsp; <span class="rango">Ordenar por</span>
    ...
    <button class="chico-linea" data-accion="ordenar" data-lista="${e}" data-por="grupo"${o}>grupo</button>`}function zt(e,a,o,t,n){return`
  <tr data-fila="${a}" data-id-fila="${e.id}"
      data-resumen="${p(go(e,n,t))}"
      class="${e.clase==="deuda"?"es-deuda":""} ${e.id===He?"abierta":""}">
    <td class="orden">
    ...
    <td class="desde">${Co(e.desdePago,"meta",e.id)}
      <div class="plazo"><span class="rango">la quiero antes del</span>
        ...
        ${e.antesDelPago&&e.antesDelPago>0?`<span class="rango">${p(j(A(e.antesDelPago,C()).optimista))}</span>`:""}</div>
    </td>
    <td class="num ritmo">
    ...
    <td class="num pagado">${kt(e)}</td>
    <td class="compra">${Nt(e)}</td>
    <td class="num">
  ...
  </tr>`}function Ht(e){let a=C(),o=new Map((e?.metas??[]).map(n=>[n.metaId,{res:n,cuando:n.pagoFin!==null?De(A(n.pagoFin,a)):null}]));if(c.metas.length===0)return`
    <section class="panel">
  ...
  <section class="panel">
    ...
    <div class="tabla-ancha">
      <table>
        ...
        <tbody>${c.metas.map((n,s)=>{let r=o.get(n.id);return zt(n,s,c.metas.length,r?.cuando??null,r?.res??null)}).join("")}</tbody>
      </table>
    </div>
    <p class="nota">
  ...
  </section>`}var Lo={tranquilo:"",pronto:"aviso",hoy:"urgente",vencido:"malo"};function Bt(){let e=new Date,a=c.soportesMarcados[Pe(e)]??[],o=ea(e,a),t=Lo[o.urgencia],n=r=>{let i=a.includes(r.id);return`<li class="soporte ${i?"listo":""}">
      <label class="interruptor">
  ...
  </section>`}function Vt(){let e=te(c.cuentas,c.ingresos),a=Ma(e);return`
  <section class="panel">
    ...
    ${c.cuentas.length===0?`<div class="vacio">A\xFAn no has registrado ninguna cuenta de cobro.<br />
        ...
        ${a.length?` &nbsp; <span class="pendiente">Te deben en total ${u($e(e))}</span>`:""}</p>`}
  </section>`}function Mo(e,a,o,t,n,s,r,i,l=""){let d=C(),m=o===null||t===null?"\u2014":`pago ${o}${t!==o?` - ${t}`:""}${n===null?"":` (${n})`}`,g=t!==null?Y(A(t,d)):i?"ya la ten\xEDas pagada":"sin terminar",f=r?`<span class="completa">${u(a)}</span>`:`<span class="pendiente">${u(s)} de ${u(a)}</span>`;return`<tr class="${l}">
    <td class="meta-nombre">${p(e)}</td>
    <td class="num">${f}</td>
    <td class="rango">${m}</td>
    <td class="cuando">${p(g)}</td>
  </tr>`}function Gt(){if(c.metas.length===0)return null;try{return re(Po())}catch{return null}}function Yt(e){if(c.metas.length===0)return`<section class="panel simulado">
      ...
      <p class="nota aviso">No pude calcular la proyecci\xF3n con estos datos.</p></section>`;let a=new Map(Oa(e).map(d=>[d.grupo,d])),o=[],t=new Set,n=(d,m="")=>Mo(d.nombre,d.valor,d.pagoInicio,d.pagoFin,d.cantidadPagos,d.totalAbonado,d.completada,d.yaEstabaPagada,m);for(let d of e.metas){if(!d.grupo){o.push(n(d));continue}if(t.has(d.grupo))continue;t.add(d.grupo);let m=a.get(d.grupo);o.push(Mo(m.grupo,m.valor,m.pagoInicio,m.pagoFin,null,m.totalAbonado,m.completado,m.yaEstabaPagado,"grupo"));for(let g of e.metas)g.grupo===d.grupo&&o.push(n(g,"componente"))}let s=e.pagos.length,r=c.escenario,i=C(),l=Y(A(s,i));return`
  <section class="panel simulado">
    ...
    <p class="nota aviso">
      ...
      ${Ye(i)?`Las fechas son de <strong>una sola posibilidad</strong>: pagos puntuales cada
    ...
    ${Qt(e)}
    ${Ut()}
  </section>`}function Ut(){let e=$e(te(c.cuentas,c.ingresos));if(e<=0)return"";let a=Fa(Po(),e);if(!a)return"";let o=C(),t=n=>Y(A(Math.max(1,n),o));return`<p class="nota ${a.seAdelanta>0?"":"rango"}">
  ...
  </p>`}function Qt(e){let a=ja(e,c.metas);if(a.length===0)return"";let o=C(),t=s=>j(A(Math.max(1,s),o).optimista),n=s=>s.termina===null?`<li class="mal"><strong>${p(s.nombre)}</strong> la quer\xEDas para
  ...
  </div>`}function ee(e){let a=Ee(c.metas),o=c.ingresos.filter(s=>s.fecha<=e.fecha&&s.id!==e.id).sort((s,r)=>s.fecha.localeCompare(r.fecha));for(let s of o){let r=c.repartos.find(i=>i.ingresoId===s.id);for(let i of r?.abonos??[])i.refId&&a.set(i.refId,Math.max(0,(a.get(i.refId)??0)-i.monto))}let t=e.cuentaDeCobroId?!o.some(s=>s.cuentaDeCobroId===e.cuentaDeCobroId):!0,n=c.escenario;return xa(e,Ca(e,o),c.obligaciones,{nombre:"Otros / Ahorro",base:n.colchonBase,minimo:n.colchonMinimo,elastico:!1},c.metas,a,t)}function Jt(){let e=Qe(c.ingresos,c.repartos);if(e.length===0)return`<section class="panel">
  ...
  <section class="panel">
  ...
  </section>`}function Xt(e){let a=c.repartos.find(i=>i.ingresoId===e.id),o=c.cuentas.find(i=>i.id===e.cuentaDeCobroId),t=p(o?o.periodo:e.nota??"de otro lado");if(!a)return`<div class="ingreso-real">
  ...
  </div>`}function wo(e){let a=C(),o=e?Ra(e.pagos,a.desde,a.diasOptimista,c.metas):[],t=Qe(c.ingresos,c.repartos),n=[...new Set([...o.map(r=>r.mes),...t.map(r=>r.mes)])],s=La(c.cuentas,c.ingresos,c.escenario.ingresoEsperado,n);return Aa(o,t,K().slice(0,7),s)}function Wt(e){let a=wo(e);if(a.length===0)return`<section class="panel">
    ...
    </section>`;Zt(a);let o=Je(a);return`
  <section class="panel">
    <h2>Vista general <span class="sufijo">\u2014 todo lo que llevas y todo lo que viene</span></h2>
    <div class="resumen">
    ...
    <div class="linea-tiempo">${a.map(en).join("")}</div>
    <p class="nota">
  ...
  </section>`}function Kt(e){let a=(n,s)=>n.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")===s.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),o=c.obligaciones.find(n=>a(n.nombre,e));if(o)return`<span class="que-es obligacion">fijo${o.grupo?` \xB7 ${p(o.grupo)}`:""}</span>`;let t=c.metas.find(n=>a(n.nombre,e));return t?`<span class="que-es meta">meta${t.grupo?` \xB7 ${p(t.grupo)}`:""}</span>`:e==="Qued\xF3 guardado"||e==="Se guardar\xEDa"?"":'<span class="que-es suelto">de una vez</span>'}var Z=new Set,Do=!1;function Zt(e){if(Do)return;Do=!0;let a=e.findIndex(t=>t.estado==="actual"),o=a>=0?a:0;for(let t of e.slice(o,o+2))Z.add(t.mes)}function en(e){let a=e.real!==null,o=e.real??e.simulado;if(!o)return"";let t=a?o.entro:e.esperado?.monto??o.entro,n=!a&&e.simulado!==null&&e.esperado!==null&&e.esperado.monto!==e.simulado.entro,s=e.real?e.real.detalle:_(e.simulado?.detalle),r=e.estado==="actual"?'<span class="chip ahora">este mes</span>':e.estado==="futuro"?'<span class="chip futuro">viene</span>':"",i=[o.aObligaciones>0?`${u(o.aObligaciones)} fijos`:"",o.aMetas>0?`${u(o.aMetas)} a metas`:"",a&&e.real.enGastos>0?`${u(e.real.enGastos)} sueltos`:"",o.alAhorro>0?`${u(o.alAhorro)} guardado`:""].filter(Boolean).join(" \xB7 ");return`
  <details class="mes-vista ${e.estado} ${a?"es-real":"es-simulado"}"
    ...
    ${s.length===0?'<p class="nota rango">Sin movimientos.</p>':`
      <div class="tabla-ancha"><table><tbody>
        ${s.map(l=>`<tr>
          <td class="meta-nombre">${p(l.nombre)} ${Kt(l.nombre)}</td>
  ...
  </details>`}var T=[],Ne=so(),ue=!1;function an(){let e=Le(),a=we();if(!e)return`
    <section class="panel">
    ...
    <div class="aviso-descartes">
      ...
      <table><tbody>
        ${T.map((t,n)=>`<tr>
          ...
          <td>${p(je(t.campo,t.valor))}</td>
          <td class="rango">en vez de ${p(je(t.campo,t.gano))}</td>
    ...
    <section class="panel">
      ...
      <p>
        <button class="primario" data-accion="nube-sincronizar" ${ue?"disabled":""}>
          ${ue?"Sincronizando\u2026":"Sincronizar ahora"}
        </button>
        <button class="chico-linea" data-accion="nube-salir">Salir de la cuenta</button>
      </p>
      ${o}
    </section>`}function on(e){let a=new Date,o=a.toLocaleDateString("es-CO",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),t=$e(te(c.cuentas,c.ingresos)),n=Be(),s=n.monto>0?ma(2,n.monto):0,r=wo(e),i=r.length>0?Je(r).guardadoDeVerdad:0,l=C(),d=fo(c.metas,e?.metas??[]),m=d?.pagoFin!=null?Y(A(d.pagoFin,l)):null,g=c.soportesMarcados[Pe(a)]??[],f=ea(a,g),v=Se(),I=v.filter(y=>g.includes(y.id)).length,x=f.diasQueFaltan,E=(y,be,fe,he,V,G)=>`
    <div class="cifra tono-${y}">
      <div class="cifra-cab"><span class="cifra-chip">${be}</span>${fe}</div>
      <div class="cifra-nombre">${he}</div>
      <div class="cifra-valor">${V}</div>
      <div class="cifra-detalle">${G}</div>
    </div>`,D='<span class="etiqueta real">Real</span>',S='<span class="etiqueta simulacion">Simulaci\xF3n</span>',O=se(c.metas,c.repartos),ae=new Map((e?.metas??[]).map(y=>[y.metaId,y])),zo=y=>pa(y,O.get(y.id)?.total??0)>=1,F=c.metas.filter(y=>!zo(y)),me=c.metas.length-F.length,ha=(F.length>0?F:c.metas).slice(0,5),ge=(F.length>0?F.length:c.metas.length)-ha.length,Ho=ha.map(y=>{let be=ae.get(y.id),fe=O.get(y.id)?.total??0,he=pa(y,fe),V=he>=1,G=!y.compra&&!V&&be?.pagoFin!=null?A(be.pagoFin,l):null,va=y.compra?"ya la compraste":V?"\u2713 lista":G?Y(G):"sin fecha todav\xEDa",Bo=G?`<span class="fecha-larga-meta">${p(va)}</span><span class="fecha-corta-meta">${p(De(G))}</span>`:p(va);return`<li class="inicio-meta ${y.clase==="deuda"?"es-deuda":""} ${V?"lista":""}">
      <div class="inicio-meta-texto">
        ...
        <div class="rango">${u(fe)} de ${u(y.valor)}</div>
        <div class="barra-progreso"><i style="width:${Math.round(he*100)}%"></i></div>
      </div>
      <div class="inicio-meta-der"><strong>${u(y.valor)}</strong>
        <span class="${V?"completa":"cuando"}">${Bo}</span></div>
    </li>`}).join("");return`
  <section class="inicio">
    ...
    <div class="aviso-radicar ${Lo[f.urgencia]}">
    ...
    <div class="panel inicio-metas">
      ...
      ${c.metas.length===0?`<div class="vacio">Todav\xEDa no has puesto ninguna meta.
            <p><button class="primario" data-accion="seccion" data-seccion="metas">Ir a Metas</button></p></div>`:`<ul class="inicio-lista">${Ho}</ul>
           ${ge>0||F.length>0&&me>0?`<p class="nota">${[ge>0?`${ge} ${ge===1?"pendiente m\xE1s":"pendientes m\xE1s"}`:"",F.length>0&&me>0?`${me} ya ${me===1?"lista":"listas"}`:""].filter(Boolean).join(" \xB7 ")} \u2014 todas en Metas.</p>`:""}`}
    </div>
    ${tn(e)}
    </div>
  </section>`}function tn(e){let a=e?ho(e.pagos):null;if(!a)return"";let o=52,t=2*Math.PI*o,n=[{nombre:"Obligaciones",valor:a.obligaciones,clase:"oblig"},{nombre:"Metas",valor:a.metas,clase:"metas"},{nombre:"Ahorro",valor:a.ahorro,clase:"ahorro"}],s=vo(n.map(i=>i.valor),o),r=De(A(a.numero,C()));return`
  <div class="panel inicio-dona">
    ...
    <div class="dona">
      <svg viewBox="0 0 140 140" role="img" aria-label="Reparto de ${u(a.ingreso)}">
        ...
        <text x="70" y="68" class="dona-total">${u(a.ingreso)}</text>
        <text x="70" y="86" class="dona-rotulo">por pago</text>
      </svg>
      <ul>
        ${n.map(i=>`<li><i class="dona-${i.clase}"></i><span>${i.nombre}</span>
          <strong>${u(i.valor)}</strong></li>`).join("")}
      </ul>
    </div>
    <p><button class="primario" data-accion="seccion" data-seccion="registrar">+ Registrar un pago</button></p>
  </div>`}function Ve(){let e=Gt();return[["inicio",on(e)],["radicacion",Bt()],["vista",Wt(e)],["escenario",wt()],["metas",Ht(e)],["proyeccion",Yt(e)],["obligaciones",_t()],["cuentas",Vt()],["real",Jt()],["nube",an()]]}function To(e){if(typeof e.querySelectorAll=="function")for(let a of Array.from(e.querySelectorAll("table"))){let o=Array.from(a.querySelectorAll("thead th")).map(t=>(t.textContent??"").trim());if(Xa(o)){a.classList.add("como-tarjetas");for(let t of Array.from(a.querySelectorAll("tbody tr"))){let n=Array.from(t.children),s=n.map(i=>Number(i.getAttribute("colspan")??1)||1),r=Ja(o,s);n.forEach((i,l)=>{let d=r[l];d?i.dataset.etiqueta=d:delete i.dataset.etiqueta})}}}}function ba(e,a){e.innerHTML=a,To(e)}function qo(){return document.activeElement?.closest?.("[data-panel]")?.dataset.panel??null}function fa(e=qo()){let a=new Set([e,ga].filter(Boolean));for(let[o,t]of Ve()){if(a.has(o))continue;let n=document.getElementById(`panel-${o}`);n&&ba(n,t)}Oo()}function Oo(){let e=document.getElementById("mensaje");e&&(e.innerHTML=M?`<div class="mensaje ${M.malo?"malo":"bueno"}">${p(M.texto)}</div>`:"",M=null)}var jo="gestiondinerotrabajo.seccion";function nn(){try{return Fe(localStorage.getItem(jo))}catch{return Fe(null)}}function sn(e){try{localStorage.setItem(jo,e)}catch{}}function rn(e){return`<nav class="barra-secciones">
  ...
  </nav>`}function cn(e){let a=Le(),o=we(),t=o?new Date(o).toLocaleString("es-CO",{day:"numeric",month:"short",hour:"numeric",minute:"2-digit"}):null;return`<aside class="lateral">
    <div class="marca"><span class="logo">$</span>
      <div><strong>Mi dinero</strong><span>Metas con ingreso variable</span></div></div>
    <nav class="nav-lateral">
      ${de.map(n=>`<button data-accion="seccion" data-seccion="${n.id}"
  ...
  </aside>`}function P(){let e=document.getElementById("app"),a=Eo(document.activeElement),o=document.activeElement,t=o&&typeof o.selectionStart=="number"?o.selectionStart:null,n=window.scrollY,s=nn();e.className=`seccion-${s}`,e.innerHTML=`
    ${cn(s)}
